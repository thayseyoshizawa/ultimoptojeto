    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Pessoas</h2>
                    <a href="create.php">Nova Pessoa</a>
                    <table class="table table-hover">
                        <tr>
                            <th>ID</th>
                            <th>Nome</th>
                        </tr>
                        <?php foreach($dao->read() as $pessoa) : ?>
                            <tr>
                                <td><?= $pessoa->getId() ?></td>
                                <td><?= $pessoa->getNome() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $pessoa->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $pessoa->getId() ?>" title="Excluir">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                     <a href="edit.php?id=<?= $pessoa->getNome() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $pessoa->getNome() ?>" title="Excluir">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                </td>
                            </tr>
