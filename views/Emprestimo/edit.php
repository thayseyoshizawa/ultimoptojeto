                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="dataEmprestimo" class="form-control" value="<?= $emprestimo->getDataEmprestimo() ?>">
                        </p>
                        <p class="form-group">
                            <label for="dataDevolucao">CNPJ</label>
                            <input type="text" name="dataDevolucao" class="form-control" value="<?= $emprestimo->getEmprestimo() ?>">
                        </p>
                        <p class="form-group">
