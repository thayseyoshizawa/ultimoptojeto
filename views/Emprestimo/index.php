    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Emprestimo</h2>
                    <a href="create.php">Novo Emprestimo</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $emprestimo) : ?>
                            <tr>
                                <td><?= $emprestimo->getId() ?></td>
                                <td><?= $emprestimo->getDataEmprestimo() ?></td>
                                <td><?= $emprestimo->getDataDevolucao() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $emprestimo->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $emprestimo->getId() ?>" title="Excluir">
