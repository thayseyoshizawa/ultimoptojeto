    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Editoras</h2>
                    <a href="create.php">Nova Editora</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $editora) : ?>
                            <tr>
                                <td><?= $editora->getId() ?></td>
                                <td><?= $editora->getNome() ?></td>
                                <td><?= $editora->getEndereco() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $editora->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $editora->getId() ?>" title="Excluir">
